...
REM ========================================================================
REM Script para verificar coordenadas no shapefile
REM ========================================================================

set "PYTHON_QGIS="
set "SHAPEFILE=%~dp0shapes\shapesFederais_07-2025.shp"
...
echo.
echo ========================================================================
echo Executando verificação de coordenadas...
echo ========================================================================
call "!PYTHON_QGIS!" "%~dp0verificar_coordenadas.py" "%SHAPEFILE%"
